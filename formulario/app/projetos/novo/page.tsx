...
export default function NovoProjetoPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 flex justify-center items-start pt-20">
      <div
        className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 max-w-lg
w-full"
      >
...
${errors.category ? "border-red-500 focus:ring-red-200" : "border-slate-300 focus:ring-blue-200"}`}
            >
